package net.goose.lifesteal.worldgen;
...
public class ModBiomeModifier {
    ...
    public static final RegistryKey<PlacedFeature> HEART_GEODE_PLACED = RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(LifeSteal.MOD_ID, "heart_geode_placed"));
    ...
    private static BiConsumer<BiomeSelectionContext, BiomeModificationContext> HEART_GEODE_MODIFIER() {
        return (biomeSelectionContext, biomeModificationContext) ->
                // here we can potentially narrow our biomes down
                // but here we won't
                biomeModificationContext.getGenerationSettings().addFeature(
    ...
    public static void register(){
        ...
        BiomeModifications.create(new Identifier(LifeSteal.MOD_ID, "features"))
                .add(ModificationPhase.ADDITIONS, BiomeSelectors.foundInOverworld(), HEART_GEODE_MODIFIER());
        BiomeModifications.create(new Identifier(LifeSteal.MOD_ID, "features"))
