...
public class HealthComponent implements IHealthComponent {
    ...
    public void spawnPlayerHead(ServerPlayerEntity serverPlayer) {
        ...
        BlockState playerHeadState = Blocks.PLAYER_HEAD.getDefaultState().with(Properties.ROTATION, RotationPropertyHelper.fromYaw(serverPlayer.getYaw()));
    ...
    public void refreshHearts(boolean healtoMax) {
        if(!livingEntity.world.isClient){
            ...
            LifeSteal.LOGGER.info(String.valueOf(livingEntity.getMaxHealth()));
            LifeSteal.LOGGER.info(String.valueOf(this.heartDifference));
